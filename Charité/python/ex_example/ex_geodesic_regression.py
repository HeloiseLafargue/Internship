...
deformetrica = dfca.Deformetrica(output_dir='/home/icm-admin/Documents/Internship/data/examples/', verbosity='INFO')

# perform a deterministic atlas estimation
model = deformetrica.estimate_principal_geodesic_analysis(template_specifications_xml, dataset_specifications_xml,
    estimator_options=estimator_options_xml,
    model_options={'deformation_kernel_type': 'keops', 'deformation_kernel_width': 9, 
                   'dtype': 'float32', 'dimension' :2, 'latent_space_dimension' : 2,
