"""
1st version : sphere and LA with deformetrica
"""
...
data_base = os.path.join(data_path, 'sphere_LA/data/')  # clean concatenation of 2 pathways 
...
data_path = '/home/icm-admin/Documents/Internship/data/'
data_base = os.path.join(data_path, 'sphere_LA/data/')
...
# set the data, model, parameters
dataset_specifications = {
    'dataset_filenames': [
        [{'sphere': os.path.join(data_base, 'Sphere_Large.vtk')}]],
    'subject_ids': ['subj1']
}
...
template_specifications = {
    'sphere': {'deformable_object_type': 'surfacemesh',
              ...
              'noise_std': 0.1,
              'filename': os.path.join(data_base, 'LA_cut_coarte.vtk'),
              'attachment_type': 'varifold'}
}
estimator_options={'optimization_method_type': 'ScipyLBFGS', 'max_iterations': 25, 'callback': estimator_callback}

# instantiate a Deformetrica object
output_path = os.path.join(data_path, 'sphere_LA/output/')
